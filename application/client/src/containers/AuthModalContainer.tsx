...
import { RequestFailError, sendJSON } from "@web-speed-hackathon-2026/client/src/utils/fetchers";
...
function getErrorCode(err: RequestFailError, type: "signin" | "signup"): string {
